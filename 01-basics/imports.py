...
print("Aktuální čas:")
print("{}.{}.{} {}:{}:{}".format(rn.day, rn.month, rn.year, rn.hour, rn.minute, rn.second))

print("Velikonoce:")
for cislo in range(2021,2026):
    velikonoce = easter(cislo)
    print(velikonoce)

print("Štědrý den v neděli:")
now = parse(str(rn.year))
next = rrule(YEARLY,dtstart=now,bymonth=12,bymonthday=24,byweekday=SU)[0].year
print(next)
